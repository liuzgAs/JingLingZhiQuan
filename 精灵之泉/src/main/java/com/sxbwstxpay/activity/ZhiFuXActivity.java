...
import com.sxbwstxpay.viewholder.ZhiFuXViewHolder;

import java.util.HashMap;

import okhttp3.Response;

public class ZhiFuXActivity extends ZjbBaseActivity implements View.OnClickListener {
    private RecyclerArrayAdapter<PayBefore> adapter;
            ...
            switch (action) {
                case Constant.BROADCASTCODE.PAY_RECEIVER:
                    ...
                    if (error == 0) {
                        ...
                        MyDialog.showTipDialog(ZhiFuXActivity.this, "支付失败");
                    } else if (error == -2) {
                        MyDialog.showTipDialog(ZhiFuXActivity.this, "支付失败");
                    }
                    break;
    ...
    private void initRecycle() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<PayBefore>(ZhiFuXActivity.this) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.view_youhui_mdx;
                return new ZhiFuXViewHolder(parent, layout,userInfo.getUid(),tokenTime,oid+"");
            }
        });
    }
    ...
    private OkObject getOkObject() {
        String url = Constant.HOST + Constant.Url.PAYBEFORE;
    ...
    public void onRefresh() {
        ApiClient.post(this, getOkObject(), new ApiClient.CallBack() {
            ...
            public void onSuccess(String s) {
                ...
                try {
                    PayBefore orderPay = GsonUtils.parseJSON(s, PayBefore.class);
                    if (orderPay.getStatus() == 1) {
                        adapter.clear();
                        adapter.add(orderPay);
                        adapter.notifyDataSetChanged();
                    } else if (orderPay.getStatus() == 3) {
                        MyDialog.showReLoginDialog(ZhiFuXActivity.this);
                    } else {
            ...
            public void showError(String msg) {
                View view_loaderror = LayoutInflater.from(ZhiFuXActivity.this).inflate(R.layout.view_loaderror, null);
