...
public class TagHotAdapter extends BaseAdapter implements OnInitSelectedPosition {
    ...
    private final List<IndexSearch.DataBean> mDataList;
    ...
    @Override
    public IndexSearch.DataBean getItem(int position) {
...
//        }
    ...
    public void onlyAddAll(List<IndexSearch.DataBean> datas) {
        mDataList.addAll(datas);
        notifyDataSetChanged();
    }

    public void clearAndAddAll(List<IndexSearch.DataBean> datas) {
        mDataList.clear();
        onlyAddAll(datas);
    }
