package com.sxbwstxpay.customview;
...
public class BoXingTu extends View {
    ...
    public BoXingTu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        paddingTopPx = DpUtils.convertDpToPixel(paddingTop, getContext());
        rect = new Rect();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        heightJianGe = (height - bianJuPx - paddingTopPx) / numShu;
    }
    ...
    public void setValueArr01(float[] value) {
        line01 = value;
        invalidate();
    }
    ...
    public void setValueArr02(float[] value) {
        line02 = value;
        invalidate();
    }
