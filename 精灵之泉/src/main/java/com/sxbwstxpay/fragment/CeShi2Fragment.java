 ...
 * Use the {@link CeShi2Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CeShi2Fragment extends ZjbBaseFragment implements View.OnClickListener {
    ...
    public CeShi2Fragment() {
        // Required empty public constructor
    }

    public static CeShi2Fragment newInstance(ArrayList<TestStyle.DataBean> dataBeans) {
        CeShi2Fragment fragment = new CeShi2Fragment();
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<TestStyle.DataBean>(getActivity()) {
            ...
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_test2;
