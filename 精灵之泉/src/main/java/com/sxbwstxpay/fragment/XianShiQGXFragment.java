 ...
 */
public class XianShiQGXFragment extends ZjbBaseFragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener , EasyPermissions.PermissionCallbacks{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mInflate == null) {
            mInflate = inflater.inflate(R.layout.fragment_xian_shi_qgx, container, false);
            init();
        }
