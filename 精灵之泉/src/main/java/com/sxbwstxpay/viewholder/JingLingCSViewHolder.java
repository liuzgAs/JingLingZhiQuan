 ...
 */
public class JingLingCSViewHolder extends BaseViewHolder<Supermarket.DataBean> {
    ...
    private Supermarket.DataBean data;

    public JingLingCSViewHolder(ViewGroup parent, @LayoutRes int res) {
        super(parent, res);
    ...
    @Override
    public void setData(Supermarket.DataBean data) {
        super.setData(data);
        this.data = data;
