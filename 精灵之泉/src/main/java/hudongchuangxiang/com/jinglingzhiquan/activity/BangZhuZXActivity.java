...
import hudongchuangxiang.com.jinglingzhiquan.viewholder.BangZhuZXViewHolder;
...
public class BangZhuZXActivity extends ZjbBaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener  {
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Integer>(BangZhuZXActivity.this) {
            @Override
