...
import hudongchuangxiang.com.jinglingzhiquan.viewholder.GongGaoViewHolder;
...
public class GongGaoActivity extends ZjbBaseActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Integer>(GongGaoActivity.this) {
            @Override
